...
import TwoColumnsBanner from "./TwoColumnsBanner";
import TwoColumnsLargeBanner from "./TwoColumnsLargeBanner";
...
const ProductCard = ({ dataAPI }) => {
  ...
  return (
    ...
    >
      ...
      {dataAPI?.main_content?.section5_two_column_banners?.status && (
        <TwoColumnsBanner
          dataAPI={dataAPI?.main_content?.section5_two_column_banners}
        />
      )}
      {dataAPI?.main_content?.section6_two_column_banners?.status && (
        <TwoColumnsLargeBanner
          dataAPI={dataAPI?.main_content?.section6_two_column_banners}
        />
      )}
